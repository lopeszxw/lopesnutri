...
Agora vamos criar a autenticação do sistema. O sistema deve permitir que uma nutricionista crie uma conta e faça login. Use o Neon Auth que já está configurado no projeto "LopesNutri".
...
- Cores predominantes azul claro e branco, remetendo à área da saúde, nutrição e bem-estar
- Logo com o texto "LopesNutri" no topo de ambas as telas